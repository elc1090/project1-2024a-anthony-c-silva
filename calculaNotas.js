...
function verifiValorMax2(input) {
    // Obtenha o valor do campo de entrada
    var valor = parseFloat(input.value);
...
function verifiValorMax3(input) {
    // Obtenha o valor do campo de entrada
    var valor = parseFloat(input.value);
...
function calcularSubTotal3() {
    ...
    var notaDominio = parseFloat(document.getElementById("dominiosDidaticos").value);
    var notaPoderSintese = parseFloat(document.getElementById("poderSintase").value);
  ...
  function calcularSubTotal7() {
    ...
    if (!isNaN(notaEstrutura) && !isNaN(notaRelOriQual) && !isNaN(notaConhecimento) && !isNaN(notaAdequacao)) {
        ...
        document.getElementById("subTotal7").value = subTotal7.toFixed(2);
    } else {
      document.getElementById("subTotal7").value = "";
    }
  ...
  function calcularTotal() {
    ...
    var subTotal7 = parseFloat(document.getElementById("subTotal7").value);
